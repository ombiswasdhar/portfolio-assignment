  ...
  return (
    ...
    >
      ...
      >
          ...
          >
            ...
            >
              ...
              <div
                ...
                onClick={() => {
                  // Playful subtle shake animation
        ...
        {/* ================= BOTTOM GLYPH & TRANSITION ================= */}
        <div className="relative mt-12 sm:mt-16 pt-4 border-t border-white/10 max-w-[760px] mx-auto flex items-center justify-between text-xs font-mono text-neutral-500">
