...
import disclaimerCleanHd from '../assets/work/disclaimer_clean_hd.png'
      ...
      >
        ...
        >
          ...
          <div className="relative w-full rounded-[28px] sm:rounded-[36px] bg-[#0E0E12] border border-white/15 p-6 sm:p-10 md:p-12 shadow-[0_30px_90px_rgba(0,0,0,0.9)] overflow-hidden group hover:border-white/25 transition-all duration-500">
            ...
            {/* Authentic Handwriting Artwork (Landscape aspect ratio ~ 3.2:1) */}
            <div className="relative w-full aspect-[1152/358] max-h-[360px] flex items-center justify-center select-none">
              <img
                src={disclaimerCleanHd}
